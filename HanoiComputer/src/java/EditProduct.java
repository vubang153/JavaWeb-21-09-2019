...
public class EditProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.setCharacterEncoding("UTF-8");
            ///String ht = request.getParameter("thoten");
            //out.println("<br>họ tên:" + ht);
            File file;
                ...
                try {
                    ...
                    while (i.hasNext()) {
                        ...
                        if (fi.isFormField()) //nếu là input thường
                        {
                            ...
                            } else if (fieldName.equalsIgnoreCase("inputProductKey")) {
                                product_key = Integer.parseInt(fi.getString("UTF-8"));
                            } else if (fieldName.equalsIgnoreCase("inputProductOldImage")) {
                                old_img = fi.getString("UTF-8");
                            } else {
                    ...
                    int result = tb_sanpham.editProduct(sp);
                    out.println(sp.getGiasp());
                    out.println(sp.getHinhanh());
                    out.println(sp.getManhom());
                    out.println(sp.getId());
                    out.println(sp.getMasp());
                    out.println(sp.getNoidung());
                    out.println(sp.getHinhanh());
